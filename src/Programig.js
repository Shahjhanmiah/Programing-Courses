...
const Programig = () => {
	...
	<section>
		<div className="container max-w-6xl p-6 space-y-6 sm:space-y-12"data-aos="zoom-in-up"ata-aos-duration="50">
			...
			<div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3"data-aos="slide-left"ata-aos-duration="50">
	...
	<section>
		<div className="container px-6 py-12 mx-auto"data-aos="slide-right"ata-aos-duration="50">
	...
	<div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-black "data-aos="zoom-in-up"ata-aos-duration="50">
		<div className="flex flex-col justify-between">
			<div className="space-y-2">
				<h2 className="text-4xl font-bold leading-tight lg:text-5xl">Let's talk!</h2>
				<div className="dark:text-gray-400">Vivamus in nisl metus? Phasellus.</div>
			</div>
			<img src="https://cdn5.vectorstock.com/i/1000x1000/74/54/user-verification-concept-metaphor-vector-32037454.jpg" alt="Contact our customer support" className="p-6  h-80 w-full" />
		</div>
		<form novalidate="" className="space-y-6 ng-untouched ng-pristine ng-valid ">
			...
			<button type="submit" className="w-full p-3 text-sm font-bold tracking-wide uppercase rounded dark:bg-violet-400 dark:text-gray-900 text-white bg-yellow-200">Send Message</button>
		</form>
	</div>
	<footer>
		<div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row">
			...
			<div className="flex flex-col justify-center pt-6 lg:pt-0">
				<div className="flex justify-center space-x-4">
					...
					<a  href="https://www.facebook.com/md.shahjhan.94064?mibextid=ZbWKwL" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900">
